...
// Initialize - Load everything in parallel for instant display
...
// Load System Info - Immediate display
async function loadSystemInfo() {
    try {
        ...
        // Silent fail - just keep dots, no error message
...
async function deleteUser(id, username) {
    ...
    try {
        console.log('Deleting user:', id, username);
...
async function deleteArticle(id, title) {
    ...
    try {
        ...
        if (result.success) {
            ...
            await loadDataMonitoring(); // Reload data
        } else {
            alert('❌ Error: ' + (result.message || 'Unknown error'));
        }
    } catch (error) {
